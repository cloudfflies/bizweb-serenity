...
//    }
    ...
    public LoginAdminPage inputUsername(String usernameString) {
        username.sendKeys(usernameString);

        return this;
    }

    public LoginAdminPage inputPassword(String passwordString) {
    ...
    public LoginAdminPage loginAllByOne(String usernameString, String passwordString) {
