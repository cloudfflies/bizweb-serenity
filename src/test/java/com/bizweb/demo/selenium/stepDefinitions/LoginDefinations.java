...
public class LoginDefinations {
    ...
    public void verifySuccess(String isError) throws Throwable {
        if (isError.equals("not")) {
            signUpSteps.verifyIsError(Boolean.FALSE);
        } else {
            signUpSteps.verifyIsError(Boolean.TRUE);
        }
    }
}
