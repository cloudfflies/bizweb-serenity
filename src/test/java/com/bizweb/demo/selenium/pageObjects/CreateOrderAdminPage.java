...
public class CreateOrderAdminPage extends PageFactory{
    ...
    public CreateOrderAdminPage(WebDriver dr) {
        driver = dr;
    ...
    public CreateOrderAdminPage searchVariant(String searchKey) {
        productSearchInput.sendKeys(searchKey);

        return this;
    }

    public CreateOrderAdminPage selectVariant(int positionNumber) {
        variantResult.get(positionNumber).click();

        return this;
    }

    public CreateOrderAdminPage createWithoutPayment() {
